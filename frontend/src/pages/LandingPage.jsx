...
import dog from "D:/PAS/frontend/public/pngegg.png"
import ani1 from "D:/PAS/frontend/public/pngegg (2).png"
import ani2 from "D:/PAS/frontend/public/pngegg (3).png"
import ani3 from "D:/PAS/frontend/public/pngegg (4).png"
import arrow from "D:/PAS/frontend/public/arrow-right.png"
import cat from "D:/PAS/frontend/public/catbottom.png"

function LandingPage() {
  
  return (
    <>  
      <div className='p-4  pt-[100px] overflow-hidden'>
        <div className=' flex  w-full'>
          <div className='pl-[70px] pt-[110px] w-2/3'>
            <h1 className='font-MPlus font-bold text-[80px]'>
              Find your new best friend
            </h1>
            <p className='font-MPlus text-[20px] pr-[180px] pt-[20px] '>
              Find a loving companion today. Explore more and bring home a friend who will cherish you forever.
            </p>
            <div className='flex pl-[50px]'>
                <svg version="1.0" xmlns="http://www.w3.org/2000/svg "
                width="250px" height="150px" viewBox="0 0 4669.000000 3592.000000"
                preserveAspectRatio="xMidYMid meet " className='absolute pt-5'>
                  <g transform="translate(0.000000,3592.000000) scale(0.100000,-0.100000)"
          ...
          <div>      
            <img className='z-20  h-[600px]  w-[450px] drop-shadow-2xl' 
              src={dog}  alt="" />
              <div className='-z-20 absolute top-[-50px] right-[-700px]'>
                <svg  id="visual" viewBox="0 0 900 600" width="2000px" height="1000px" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1">
                  <g transform="translate(500.47357223413337 331.7033095111367)"><path d="M134.8 -156C159.8 -109.8 154.9 -54.9 151.6 -3.3C148.3 48.3 146.6 96.6 121.6 124.3C96.6 152 48.3 159 -7 165.9C-62.2 172.9 -124.5 179.8 -174.5 152.1C-224.5 124.5 -262.2 62.2 -254.2 8C-246.2 -46.2 -192.4 -92.4 -142.4 -138.6C-92.4 -184.7 -46.2 -230.9 4.4 -235.2C54.9 -239.6 109.8 -202.2 134.8 -156" fill="#FDD835"></path>
                  </g>
                </svg>
              </div>
          </div>
      ...
      <div className='ml-[160px] w-4/5 h-[230px] my-[180px] bg-[#FDD835]  rounded-sm  flex justify-center gap-[50px]  '>
        <NavLink to="/dogs">
        <div className=' m-[50px] w-[200px] bg-white h-[240px] shadow-2xl rounded-sm p-[10px] '>
          <img className='h-[160px] m-1 w-[200px] drop-shadow-2xl ' 
            src={ani1} alt="" />
            <ul className=' text-center font-MPlus text-[20px]'>
              Find a Dog
            </ul>  
        </div>
        </NavLink>
        <NavLink to="/cats"> 
        <div className=' m-[50px] w-[200px] bg-white  h-[240px] shadow-2xl rounded-sm p-[10px] '>
          <img className='h-[150px]  w-[160px] m-3 drop-shadow-2xl ' 
            src={ani2} alt=""/>
            <ul className=' text-center font-MPlus text-[20px]'>
              Find a Cat
            </ul>  
        ...
        <NavLink to="/pets">
        <div className=' m-[50px] w-[200px] bg-white h-[240px] shadow-2xl rounded-sm p-[10px] '>
          <img className='h-[160px] mx-11 w-[150px]drop-shadow-2xl   '
            src={ani3} alt=""  />
            <ul className='py-4 text-center font-MPlus text-[20px]'>
              Find other animal
            </ul>  
        </div>
        </NavLink>
      </div>
      <div className=' flex pt-20 h-[700px]  w-full bg-[#FDD835]  '> 
        <img src={cat} alt=""  className='drop-shadow-2xl'/>
          <div>
            <h1 className='font-MPlus text-[80px] px-[100px] pt-[50px] font-bold '>
              Homeless pets deserve a place to call home 
            </h1>
            <NavLink to={"/shelter"}>
            <img src={arrow} alt="" className='absolute h-[100px] w-[100px] top-[1700px] left-[1090px]'  />
            </NavLink>   
          </div>
      </div>      
    </>
